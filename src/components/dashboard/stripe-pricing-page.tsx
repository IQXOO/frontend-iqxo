          ...
          <div className="relative px-5 pb-6 pt-5 sm:px-7 sm:pb-7 sm:pt-6">
            ...
            <div className="px-0 py-10 sm:px-1 sm:py-12">
              ...
              <div className="mt-4 flex flex-col items-center gap-2">
                ...
                <div className="mt-5 pt-5 border-t border-white/5 w-full flex justify-center items-center gap-6 sm:gap-7">
                  {[
                    {
                      name: "Facebook",
                      url: "https://www.facebook.com/IQXO",
                      icon: (
                    ...
                    {
                      name: "TikTok",
                      url: "https://www.tiktok.com/@iqxoapp?_r=1&_t=ZS-9858CEzLA6H",
                      icon: (
                        <svg className="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a
                      ...
                      className="text-[#E8E8E8] dark:text-white hover:text-[#5BC0DE] dark:hover:text-[#5BC0DE] transition-all duration-200 hover:scale-110 active:scale-95"
                    >
                      {social.icon}
                    </a>
                  ))}
