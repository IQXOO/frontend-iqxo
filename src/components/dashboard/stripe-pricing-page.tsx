  ...
  useEffect(() => {
    ...
    const handleProductsResult = (e: Event) => {
      ...
      if (products && products.length > 0) {
        const monthly = products.find((p: { identifier: string; priceString?: string }) => p.identifier === "com.iqxo.premium.monthly");
        const yearly = products.find((p: { identifier: string; priceString?: string }) => p.identifier === "com.iqxo.premium.yearly");
  ...
  const handleTrial = async () => {
    ...
    if (trialActive) {
      toast({
        ...
        description: t(
          "You already have an active 14-day free trial. Enjoy all features!",
          "Vous avez déjà un essai gratuit de 14 jours actif. Profitez de toutes les fonctionnalités !",
          "لديك تجربة مجانية لمدة 14 يوم نشطة بالفعل. استمتع بجميع الميزات!",
        ),
      });
      onClose?.();
      return;
    ...
    try {
      ...
      toast({
        ...
        description: t(
          ...
          "Votre essai gratuit de 14 jours a commencé. Profitez de toutes les fonctionnalités !",
          "بدأت تجربتك المجانية لمدة 14 يوم. استمتع بجميع الميزات!",
        ),
      });
      onClose?.();
    } catch (err) {
            ...
            <div className="px-0 py-10 sm:px-1 sm:py-12">
              <div className="mx-auto max-w-[640px] text-center">
                ...
                <div className="mt-10 inline-flex items-center gap-2 rounded-full border border-[rgba(91,192,222,0.12)] bg-[rgba(91,192,222,0.08)] px-5 py-2 text-[0.8rem] font-normal text-[var(--cyan)]">
                  ...
                  {t("14 Days of Calm — Free", "14 jours de calme — Gratuit", "14 يوم من الهدوء — مجاناً")}
                </div>
              ...
              <div className="mt-12 grid grid-cols-1 gap-3 md:grid-cols-3 md:gap-4 lg:gap-4">
                ...
                >
                  ...
                  <div className="text-[0.65rem] uppercase tracking-[0.3em] text-[var(--cyan)] opacity-80">
                    {t("14 Days of Calm", "14 jours de calme", "14 يوم من الهدوء")}
                  </div>
                ...
                <div className="md:col-span-3 mx-auto mt-6 max-w-[600px] rounded-[16px] border border-[var(--border)] bg-[var(--bg-card)] px-5 py-5 text-center">
                  <p className="text-[0.85rem] leading-6 text-[#A0A0A8]">
                    {t(
                      "After your 14-day trial, continue Free with 10 captures/month.",
                      "Après votre essai de 14 jours, continuez gratuitement avec 10 captures/mois.",
                      "بعد تجربتك لمدة 14 يوم، يمكنك المتابعة مجانًا مع 10 عمليات التقاط شهريًا.",
                    )}{" "}
              ...
              <div className="mt-4 flex flex-col items-center gap-2">
                ...
                <div className="mt-7 pt-7 border-t border-white/5 w-full flex flex-col items-center">
                  <div className="flex items-center justify-center gap-3 sm:gap-4 mb-6">
                    <div className="h-[1px] w-10 sm:w-16 bg-gradient-to-r from-transparent via-white/10 to-white/25" />
                    <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full border border-white/10 bg-white/[0.03] backdrop-blur-md shadow-[0_0_25px_rgba(91,192,222,0.08)] hover:border-[#5BC0DE]/40 transition-all duration-300">
                    ...
                    <div className="h-[1px] w-10 sm:w-16 bg-gradient-to-l from-transparent via-white/10 to-white/25" />
                  </div>
                  <div className="inline-flex items-center justify-center gap-6 sm:gap-7 px-7 py-3.5 rounded-2xl border border-white/5 bg-white/[0.015] backdrop-blur-xl shadow-[0_4px_24px_rgba(0,0,0,0.4)] hover:border-white/10 transition-all duration-300">
                    {[
                      {
                        name: "Facebook",
